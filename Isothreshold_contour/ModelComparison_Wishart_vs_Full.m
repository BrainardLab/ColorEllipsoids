...
plot_2D_isothreshold_contour(stim.x_grid_ref, stim.y_grid_ref, ...
    ...
    'figName', ['Comparison_IsothresholdContours_WishartM_vs_gtM_',plane_slc,'_sim',num2str(sim.nSims),'perCond_',...
...
figName1 = ['Comparison_axisRatio_WishartM_vs_gtM_',plane_slc,'_sim',num2str(sim.nSims),'perCond_',...
            'sampling',sim.method_sampling,'_jitter',num2str(sim.random_jitter),'_rng1to',num2str(nDataFiles)];
...
%rotation angle
figName2 = ['Comparison_rotAngle_WishartM_vs_gtM_',plane_slc,'_sim',num2str(sim.nSims),'perCond_',...
            'sampling',sim.method_sampling,'_jitter',num2str(sim.random_jitter),'_rng1to',num2str(nDataFiles)];
