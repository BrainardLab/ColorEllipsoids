...
nDataFiles     = 10; %10
plane_slc      = 'GB plane';
numSimPerCond  = 480;%480
samplingMethod = 'Random'; %'Random'; 'NearContour'
samplingJitter = 0.2;   %applicable only for 'NearContour'
...
plot_comparison_WishartM_vs_fullM(squeeze(gtM_ellParam(:,:,2))./squeeze(gtM_ellParam(:,:,1)),...
    ...
    'figPos',[0,0.1,0.3,0.5],'paperSize',[25,25],'saveFig',true,'figName',...
