clear all; close all; clc; parpool(5);
...
nDataFiles = 1;
for s = 1:nDataFiles
    load(['Sims_isothreshold_GB plane_sim240perCond_samplingNearContour_',...
    ...
    lb  = -0.25.*ones(1, fits.nFreeParams); 
    ub  =  0.25.*ones(1, fits.nFreeParams); 
    plb = -0.1.*ones(1, fits.nFreeParams); 
    pub =  0.1.*ones(1, fits.nFreeParams); 
