...
output_figDir1 = os.path.join(base_dir, 'ELPS_analysis','Simulation_FigFiles','Python_version','2d_oddity_task')
output_figDir2 = os.path.join(base_dir, 'ELPS_analysis','ModelFitting_FigFiles','Python_version','2D_oddity_task','random_ref')
output_fileDir = os.path.join(base_dir, 'ELPS_analysis','ModelFitting_DataFiles','2D_oddity_task','random_ref')
