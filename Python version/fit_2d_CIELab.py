...
plane_2D_idx  = 2
sim_jitter    = 0.3
nSims         = 240 #number of simulations: 
rnd_seed      = 0
...
file_sim = f"Sims_isothreshold_{plane_2D}_{colordiff_alg}_sim{nSims}perCond_"+\
...
fig_name_part1 = f'Fitted{file_sim[4:-4]}_bandwidth{BANDWIDTH}'
...
wishart_pred_vis.plot_2D(
    ...
    modelpred_alpha = 1,
    fontsize = 9,
    fig_name = f"{fig_name_part1}_withSamples.pdf") 
...
wishart_pred_vis.plot_2D(
    ...
    modelpred_alpha = 0.5,
    fontsize = 9,
    fig_name = f"{fig_name_part1}.pdf") 

        
#%% save data
output_file = f"{fig_name_part1}_decay{model.decay_rate}_oddity.pkl"
...
variable_names = ['plane_2D','sim_jitter','nSims','rnd_seed','colordiff_alg',
                  ...
                  'model','model_pred_Wishart', 'sim_trial_by_CIE', 
