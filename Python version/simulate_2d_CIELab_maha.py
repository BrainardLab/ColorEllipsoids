...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 15:03:24 2024
...
from core import optim, model_predictions, oddity_task_mahalanobis
from core.wishart_process import WishartProcessModel

sys.path.append("/Users/fangfang/Documents/MATLAB/projects/ColorEllipsoids")
import model_predictions_maha
...
BANDWIDTH    = 0.1        # Bandwidth for logistic density function.
...
file_fits = 'Fitted' + file_sim[4:-4] + '_bandwidth0.001.pkl' 
...
recover_fitEllipse_scaled, recover_fitEllipse_unscaled,\
    ...
    model_predictions_maha.convert_Sig_2DisothresholdContour_oddity_batch(xref_raw,\
...
model_predictions.plot_2D_modelPredictions_byWishart(
    ...
    figDir = fig_outputDir,fig_name = fig_name_part1 +'_withSamples_maha') #recover_fitEllipse_scaled
